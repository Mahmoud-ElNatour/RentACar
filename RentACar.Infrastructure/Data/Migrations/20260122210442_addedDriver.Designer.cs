...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentACar.Core.Entities.Driver", b =>
                {
                    ...
                    b.Property<bool>("IsAvailableManual")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true)
                        .HasColumnName("isAvailableManual");
            ...
            modelBuilder.Entity("RentACar.Core.Entities.DriverLocation", b =>
                {
                    b.Property<int>("DriverLocationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("driverLocationID");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DriverLocationId"));
                    ...
                    b.Property<bool>("IsTrackingActive")
                        .HasColumnType("bit")
                        .HasColumnName("isTrackingActive");
            ...
            modelBuilder.Entity("RentACar.Core.Entities.Driver", b =>
                {
                    b.HasOne("RentACar.Core.Entities.AspNetUser", "User")
                        .WithOne("Driver")
                        .HasForeignKey("RentACar.Core.Entities.Driver", "AspNetUserId")
                        .IsRequired()
