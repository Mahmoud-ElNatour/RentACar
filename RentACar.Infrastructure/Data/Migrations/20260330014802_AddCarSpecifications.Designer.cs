...
namespace RentACar.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260330014802_AddCarSpecifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentACar.Core.Entities.AiConversation", b =>
                {
                    ...
                    b.HasIndex("CustomerId")
                        .HasDatabaseName("IX_AiConversations_CustomerId");

                    b.HasIndex("LastActiveAt")
                        .HasDatabaseName("IX_AiConversations_LastActiveAt");

                    b.ToTable("AiConversations");
                });

            modelBuilder.Entity("RentACar.Core.Entities.AiMessage", b =>
                {
            ...
            modelBuilder.Entity("RentACar.Core.Entities.Car", b =>
                {
                    ...
                    b.Property<bool>("HasInfotainmentScreen")
                        .HasColumnType("bit")
                        .HasColumnName("hasInfotainmentScreen");

                    b.Property<bool>("HasParkingSensors")
                        .HasColumnType("bit")
                        .HasColumnName("hasParkingSensors");

                    b.Property<bool>("HasRearCamera")
                        .HasColumnType("bit")
                        .HasColumnName("hasRearCamera");

                    b.Property<bool>("HasSunroof")
                        .HasColumnType("bit")
                        .HasColumnName("hasSunroof");
                    ...
                    b.Property<int>("SeatsCapacity")
                        .HasColumnType("int")
                        .HasColumnName("seatsCapacity");

                    b.Property<bool>("SupportsBabySeat")
                        .HasColumnType("bit")
                        .HasColumnName("supportsBabySeat");
            ...
            modelBuilder.Entity("RentACar.Core.Entities.Expense", b =>
                {
            ...
            modelBuilder.Entity("RentACar.Core.Entities.ExpenseCategory", b =>
                {
                    b.Property<int>("ExpenseCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentACar.Core.Entities.AiMessage", b =>
                {
                    b.HasOne("RentACar.Core.Entities.AiConversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("RentACar.Core.Entities.Expense", b =>
                {
                    ...
                    b.HasOne("RentACar.Core.Entities.ExpenseCategory", "ExpenseCategory")
                        .WithMany("Expenses")
